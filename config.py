...
DATABASE_NAME = os.environ.get("DATABASE_NAME", "Ganeshmoury7797")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Ganeshmoury7797:97541152@cluster0.kodqjqk.mongodb.net/?retryWrites=true&w=majority")
